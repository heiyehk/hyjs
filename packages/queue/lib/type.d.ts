...
export declare type QueueEvent = 'success' | 'start' | 'stop' | 'pause' | 'resume' | 'running' | 'add' | 'remove' | 'finish' | 'clear' | 'error' | 'timeout' | 'retry' | 'retryError' | 'retryTimeout' | 'retryMaxAttempts' | 'retryMaxDelay' | 'retryBackoff' | 'retryJitter' | 'retryDelay' | 'retryFilter' | 'retryHandle' | 'retryOnTimeout';
