 ...
 * @returns
 */
export var randomCode = function () {
 ...
 * @param file 文件
 */
export var fileReaderToBase64 = function (file) {
 ...
 */
export var convertBase64UrlToBlob = function (urlData, type, filename) {
 ...
 */
export var filterParamsEmpty = function (data, validation) {
    var e_1, _a;
    var newObj = {};
    try {
 ...
 * @returns
 */
export var getVideoDuration = function (file) {
